...
public class _2_Better_Using_HashMap____________ONLY_If_Index_Is_required {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         Suppose 2+ margin =9 -> margin=7

         than search this margin if its present in array. this pair is ans.
        ...
        for(int i = 0; i<arr.length; i++){
            int a = arr[i];           //  if a = 7
            int margin = k - arr[i];  //  margin = 9-7 = 2 | Now search for 2 as b
            /*
            its costly ( oh no )
            ...
            if(m.containsKey(margin)){
                System.out.println(a + " "+margin);
                System.out.println(i + " "+ m.get(margin)); // ----> If require Indexes.
                System.out.println("---------");
            }
        }
        /*
